...
- Self-evolving, Sustainable AI: Data/task Curation & Exploration, Auto-benchmarking;
...
* 2026/03: I will serve as the Area Chair for [NeurIPS 2026](https://neurips.cc/) and most [ARR circles](https://aclrollingreview.org/dates) (ACL, EMNLP, etc.). 
* 2026/01: I am visiting [MBZUAI, UAE](https://mbzuai.ac.ae/) as a [Visiting Assistant Professor](https://mbzuai.ac.ae/study/faculty/tianyi-zhou/) for one year and has experienced the [2026 Middle East Conflict](https://huggingface.co/papers/2603.16642). 
...
* 2025/05: 6 works (3 main with <span style="color:red">*2 Oral*</span> + 3 findings) have been accepted by [ACL 2025](https://2025.aclweb.org/).
* 2025/05: 3 works have been accepted by [ICML](https://icml.cc/): [R2-T2](https://github.com/tianyi-lab/R2-T2) (Test-Time Multimodal MoE), [Preference Controllable Multi-Objective RL](https://github.com/YYCAAA/ICML25PCRL), and [Tilted Sharpness-Aware Minimization](https://arxiv.org/abs/2410.22656).
...
* 2025/04: We release two works investigating how traning data for LLMs ([slow vs. fast thinking](https://huggingface.co/papers/2410.23743), [instruction vs. reasoning](https://huggingface.co/papers/2504.10766)) lead to different layer-wise gradient patterns and training dynamics, from which we unified vairous existing data quality metrics into one: small but diverse gradient directions indicate better data. 
* 2025/04: We release [ATLaS](https://arxiv.org/abs/2503.02197) and [EEF](https://arxiv.org/abs/2504.13145) that study better usage of expert trajectories in supervised/reinforcement finetuning of LLM agents. ATLaS selects only 30% critical steps from expert trajectories to achieve better generalization across tasks/envs, while EEF show that expert failed trajectories can considerably improve the agent exploration in RL.   
