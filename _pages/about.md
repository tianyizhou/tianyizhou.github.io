...
News
------
* 2024/05: 4 ICLR + 4 ICML + 6 ACL + 2 NAACL + 2 CVPR are accepted in 2024, featuring our works on controllable generative models, personalized AI, data-efficient instruction finetuning and RLHF of LLMs, prompt optimization, multi-modal hallucinations, multi
-modal agent and embodied agent, and curriculum reinforcement learning.  
