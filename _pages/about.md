...
My recent works study how, when, and why to translate human learning strategies to improve machine learning in the wild (with imperfect data or adaption to different tasks, domains, environments, etc.), via empirical and theoretical analysis of the underlying memorization mechanism revealed by the training dynamics of neural networks, using mathematical tools from discrete and continuous optimization. Our long-term goal is to develop more powerful, efficient, trustworthy, and smarter hybrid (coevolution) intelligence between human and machine. 
