...
redirect_from: 
  ...
  - /about.html
---
I am a Ph.D. student in [Paul G. Allen School of Computer Science and Engineering](https://www.cs.washington.edu/) at [University of Washington](https://www.washington.edu/). I am a member of [MELODI lab](https://melodi.ece.uw.edu/), advised by [Prof. Jeff A. Bilmes](https://people.ece.uw.edu/bilmes/p/pgs/index.html). I have published [~50 papers](https://scholar.google.com/citations?user=OKvgizMAAAAJ&hl=en) at NeurIPS, ICML, ICLR, AISTATS, NAACL, COLING, KDD, ICDM, AAAI, IJCAI, ISIT, Machine Learning (Springer), IEEE TIP, IEEE TNNLS, IEEE TKDE, etc. I am the recipient of the [Best Student Paper Award at ICDM 2013](https://tianyizhou.files.wordpress.com/2010/08/dca-paper.pdf) and the [2020 IEEE Computer Society Technical Committee on Scalable Computing (TCSC) Most Influential Paper Award](http://www.icml-2011.org/papers/41_icmlpaper.pdf).

My research interests are in machine learning, optimization, and natural language processing. My recent works study how, when, and why to translate human learning strategies to improve machine learning in the wild (with imperfect data or adaption to different tasks/domains/environments), via empirical and theoretical analysis of the underlying memorization mechanism revealed by the training dynamics of neural networks, using mathematical tools from discrete and continuous optimization. Our long-term goal is to develop more powerful, efficient, trustworthy, and smarter hybrid (coevolution) intelligence between human and machine. 
