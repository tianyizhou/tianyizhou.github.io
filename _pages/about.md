...
* 2025/04: We release two works [ATLaS](https://arxiv.org/abs/2503.02197) and [EEF](https://arxiv.org/abs/2504.13145) that aim to improve the usage of expert trajectories in supervised/reinforced finetuning of LLM agents. ATLaS show that only learning experts' 30% critical steps can improve the agent's generalization across tasks/envs, while EEF show that the expert failed trajectories should not be wasted and can considerably improve the agent exploration in RL.   
